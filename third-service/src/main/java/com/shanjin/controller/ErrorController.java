...
public class ErrorController {
	...
	public @ResponseBody Object vaildateFailed() {
		JSONObject jsonObject = new ResultJSONObject("01", "令牌失效，为了您的安全请退出重新登录");
		return jsonObject;
	}

	@RequestMapping("/paraError")
	@SystemControllerLog(description = "参数错误")
	public @ResponseBody Object paraError() {
		JSONObject jsonObject = new ResultJSONObject("01", "参数错误，请检查参数");
		return jsonObject;
	}
