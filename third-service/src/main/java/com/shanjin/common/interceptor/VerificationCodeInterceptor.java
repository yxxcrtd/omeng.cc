...
public class VerificationCodeInterceptor implements HandlerInterceptor {
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object arg2, Exception arg3) throws Exception {
		...
		commonCacheService.deleteObject(CacheConstants.VALIDATE_VERIFICATION_CODE_KEY, phone,verificationCode);
	}
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		try {
			...
			if (commonCacheService.getObject(CacheConstants.VALIDATE_VERIFICATION_CODE_KEY, phone, verificationCode) != null) {
			...
			commonCacheService.setObject(paramMap, CacheConstants.MERCHANT_PRE_VERIFY_TIMEOUT, CacheConstants.VALIDATE_VERIFICATION_CODE_KEY, phone, verificationCode);
