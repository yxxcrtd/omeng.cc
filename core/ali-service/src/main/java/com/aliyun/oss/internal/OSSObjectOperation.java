...
public class OSSObjectOperation extends OSSOperation {
    ...
    public void setObjectAcl(String bucketName, String key, CannedAccessControlList cannedAcl) 
        ...
        Map<String, String> headers = new HashMap<String, String>();
        populateObjectAclHeaders(cannedAcl, headers);
    ...
    private <RequestType extends PutObjectRequest, ResponseType> 
    	...
    	if (originalRequest.getFile() != null) {
        	...
        	if (!checkFile(toUpload)) {
        		getLogger().info("Illegal file path: " + toUpload.getPath());
    ...
    private void populateObjectAclHeaders(CannedAccessControlList cannedAcl, 
    		Map<String, String> headers) {
