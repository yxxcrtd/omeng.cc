...
public class PushAndroidMessageToSHB implements Runnable {

	static String host = "http://sdk.open.api.igexin.com/apiex.htm";
	private static Logger logger = Logger.getLogger(PushAndroidMessageToSHB.class);
	...
	public PushAndroidMessageToSHB(String appType, List<Map<String, Object>> AndroidPushInfo, String transmissionContent, IAndroidAppPushConfigDao androidAppPushConfigDao, ICommonCacheService commonCacheService) {
		...
		if (pushMap != null) {
			...
			try {
				...
				for (Map<String, Object> pushInfo : AndroidPushInfo) {
					...
					transData = transData.concat("," + StringUtil.null2Str(pushInfo.get("merchantId")));
