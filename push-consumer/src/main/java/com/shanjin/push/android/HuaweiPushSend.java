...
//			String android="{\"notification_title\":\"O盟\",\"notification_content\":\""+StringUtil.null2Str(msg.get("alertMsg"))+"\",\"doings\":3,\"url\":\"\",\"extras\":[{\"userId\":\""+concatValue+"\"},{\"merchantId\":\""+merchantId+"\"},{\"orderId\":\""+orderId+"\"}]}";
