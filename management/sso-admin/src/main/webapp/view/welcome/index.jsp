...
function changeValidateCode(obj) {  
    ...
    obj.src = "/welcome/showImage?d=" + currentTime;  
};
</script>
	</head>
	<body>
		<div id="pageContainer">
			<form action="/welcome/login" method="post" onsubmit="return valid(this.form)" name="form1" id="form1" >
			<div class="loginPannel">
				<p class="tishi">${error}</p>
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<th colspan="2" align="center" class="logo_"><img src="${CONTEXT_PATH}/view/image/login/logo.png" width="136"></th>
					</tr>
					<tr>
						<th width="20%">账&nbsp;&nbsp;&nbsp;&nbsp;号:</th>
					...
					<tr>
						<th></th>
						<td><span class="le"><img id="check" onclick="changeValidateCode(this)" src="/welcome/showImage" width="96"/></span>
