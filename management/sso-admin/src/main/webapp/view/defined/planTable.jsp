...
Ext.onReady(function() {
  ...
  //点击下一页时传递搜索框值到后台  
	...
	items:[
	    	   ...
	    	   <cms:havePerm url='/defined/addPlanTable'>
		       ...
		       <cms:havePerm url='/defined/deletePlanTable'>
      ...
      },
      {
        	...
        	items:[{ xtype: 'textfield',id:'service_type_name',name: 'service_type_name',fieldLabel: '服务名称',labelAlign:'left',labelWidth:60},'-',
        	       ...
        	       <cms:havePerm url='/defined/getPlanTableList'>
  ...
  //加载数据  
    ...
    <cms:havePerm url='/defined/editPlanTable'>
...
function showDetail(id,name){
	  ...
	  parent.addTab("plan_table_"+id,"表【"+name+"】详情","Fuwushangyunyingxinxiguanli","/defined/planModelShow?object_id="+id); 	 
}
