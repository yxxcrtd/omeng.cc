...
//        });
        store = Ext.create("Ext.data.Store",{
            ...
            proxy:{
                type:'ajax',
                url:'/financial/statementAlipayData',
                reader:{
                    type:'json',
                    totalProperty:'total',
                    root:'data',
        ...
        Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {header: '支付宝对账笔数', dataIndex: 'ali_num'},
                {header: '支付宝对账金额', dataIndex: 'ali_amount'},
                ...
                {header: '操作', dataIndex: 'id',renderer:function(val,p, r){
                    var html = "";
                    if(r.data["result"] == 0){
                        html += "<a href='javascript:;' onclick=\"re('"+r.data["bill_date"]+"')\">重新对账</a>";
                        html += "&nbsp;";
                    }
...
//            height: 200,
    ...
    function re(day){
        ...
        Ext.Ajax.request({
            url: '/financial/reconciliationAlipay',
            params: {day:day},
    ...
    function showDetail(id, day){
        parent.addTab("financial_statement_alipay_detail"+id,"支付宝对账单详情","financial_statement_alipay_detail","/financial/statementAlipayDetail?day="+day);
