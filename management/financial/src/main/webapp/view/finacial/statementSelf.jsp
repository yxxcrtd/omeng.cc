...
//        });
        store = Ext.create("Ext.data.Store",{
            ...
            proxy:{
                type:'ajax',
                url:'/financial/statementSelfData',
                reader:{
                    type:'json',
                    totalProperty:'total',
                    root:'data',
        ...
        Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {header: '钱包对账笔数', dataIndex: 'wallet_num'},
                {header: '钱包金额', dataIndex: 'wallet_amount'},
...
//            height: 200,
    ...
    function re(day){
        ...
        Ext.Ajax.request({
            url: '/financial/reconciliationSelf',
            params: {day:day},
    ...
    function showDetail(id, day){
        parent.addTab("financial_statement_self_detail"+id,"内部对账单详情","financial_statement_self_detail","/financial/statementSelfDetail?day="+day);
