...
<link href="http://pmg.oomeng.cn/manager/ExtJS4.2/resources/css/ext-all-neptune-rtl.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="http://pmg.oomeng.cn/financial/date/UX_TimePickerField.js"></script>
    <script type="text/javascript" src="http://pmg.oomeng.cn/financial/date/UX_DateTimePicker.js"></script>
    <script type="text/javascript" src="http://pmg.oomeng.cn/financial/date/UX_DateTimeMenu.js"></script>
    <script type="text/javascript" src="http://pmg.oomeng.cn/financial/date/UX_DateTimeField.js"></script>
