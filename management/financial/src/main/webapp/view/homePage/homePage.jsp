...
<script type="text/javascript" src="http://pmg.oomeng.cn/financial/js/homePage.js"></script>
                            	...
                            	edit_winForm.getForm().submit({  
                                          ...
                                          success: function(fp, o) {  
                                            ...
                                            if (o.result== true) { 
	                                         ...
	                                         window.location.href = '/system/showLoginUserInfo';
...
<body>
     <div id="north-div" style="height: 110px; background-color: #232323;"><img alt="善金科技管理平台" style="padding-left: 60px; padding-top : 19px" src="http://pmg.oomeng.cn/financial/image/shanjin.png">
     <div class="sys_h_r">
     ...
     <div>
      ...
      <cms:havePerm url='/system/editSystemUserInfo'>
