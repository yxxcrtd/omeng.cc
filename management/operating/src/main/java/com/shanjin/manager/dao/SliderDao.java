...
public interface SliderDao {
	...
	Boolean saveSearchStatisticsAttch(Map<String, String[]> param, String resultPath);
	...
	int saveCatalog(Map<String, String[]> param, String smallPath, String bigPath);

	boolean addRootCatalog(Map<String, String[]> param, String smallPath, String bigPath);
