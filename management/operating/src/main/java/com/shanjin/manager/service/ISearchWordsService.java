...
public interface ISearchWordsService {
	...
	List<Pair> getExportSearchWordsTitles();

	List<AppKey> exportAppKeywords(Map<String, String[]> param);

	List<Pair> getExportAppKeyTitles();
