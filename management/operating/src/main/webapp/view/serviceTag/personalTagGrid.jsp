...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'状态',dataIndex:'is_audit',align:'center',renderer:function(value){  
           		  ...
           		  {header:'搜索次数',dataIndex:'seach_count',align:'center'},
    ...
    var store = Ext.create("Ext.data.Store",{
        ...
        proxy:{  
            type:'ajax',  
            url:'/serviceTag/personalTagList',  
            reader:{  
                type:'json',  
                totalProperty:'total',  
                root:'data',  
    ...
    var grid = Ext.create("Ext.grid.Panel",{
        ...
        dockedItems: [{
        	...
        	displayInfo: true,
        	items:[
        	       <cms:havePerm url='/serviceTag/addPersonalTag'>
        	       ...
        	       <cms:havePerm url='/serviceTag/deletePersonalTag'> 
        	...
        	items:[{ xtype: 'textfield',id: 'tag',name: 'tag',fieldLabel: '标签',labelAlign:'left',labelWidth:60},'-',
				   ...
				   <cms:havePerm url='/serviceTag/personalTagList'> 
  ...
  //加载数据  
    ...
    <cms:havePerm url='/serviceTag/editPersonalTag'> 
     ...
     {  
          ...
          {  
             ...
             Ext.Msg.confirm("提示信息","请确定要执行删除操作吗?",function (btn){  
                 ...
                 {  
                     Ext.Ajax.request({  
                         url:"/serviceTag/deletePersonalTag",  
                         params:{ids:id},  
                         method:'post',  
                         success:function(o){  
