...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'app类型',dataIndex:'appName',sortable:true,width:50,align:'center'},
  ...
  //加载数据  
   ...
   // cityStore.load();
	...
	function exportAll() {
         ...
         window.location.href = '/valueAdded/exportAdviserApplyExcel?merchantName='+merchantName+'&telephone='+telephone+'&province='+province
