...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'服务ID',dataIndex:'gxfwServiceTypeId',sortable:true,fixed:false},
                   {header:'服务',dataIndex:'gxfwName',sortable:true,fixed:false},
                   {header:'关联服务ID',dataIndex:'serviceTypeId',sortable:true,fixed:false},
                   {header:'关联服务',dataIndex:'serviceTypeName',sortable:true,fixed:false}
               ];
  ...
  //点击下一页时传递搜索框值到后台  
	...
	items:[
	    	   ...
	    	   <cms:havePerm url='/systemManager/addPushConfig'>
		       ...
		       <cms:havePerm url='/systemManager/deletePushConfig'>
      ...
      },
      {
        	...
        	dock:'top',
        	displayInfo: true,
        	items:[{ xtype: 'textfield',id:'gxfwName',name: 'gxfwName',fieldLabel: '服务',labelAlign:'left',labelWidth:60},'-',
