...
function changeValidateCode(obj) {  
	...
	<body>
		<div id="pageContainer">
			<form action="/systemManager/login" method="post" onsubmit="return valid(this.form)" name="form1" id="form1" >
			<div class="loginPannel">
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<th></th>
						<td><span class="le"><img id="check" onclick="changeValidateCode(this)" src="/systemManager/showImage" width="96"/></span>
