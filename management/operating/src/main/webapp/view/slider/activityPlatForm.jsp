...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'平台',dataIndex:'platform',sortable:true,fixed:false}
    ...
    var store = Ext.create("Ext.data.Store",{
        ...
        proxy:{  
            type:'ajax',  
            url:'/slider/getActivityPlatFormReleation',  
            reader:{  
                type:'json',  
                totalProperty:'total',  
                root:'data',  
  ...
  //点击下一页时传递搜索框值到后台  
	...
	displayInfo: true,
	items:[
	    	   <cms:havePerm url='/slider/addActivityPlatForm'>
		       ...
		       <cms:havePerm url='/slider/deleteActivityPlatForm'>
      ...
      },
      {
        	...
        	items:[
        	       ...
        	       <cms:havePerm url='/slider/getActivityPlatFormReleation'>
  ...
  //加载数据  
    ...
    {  
         ...
         Ext.Msg.confirm("提示信息","请确定要执行删除操作吗?",function (btn){  
             ...
             {  
                 Ext.Ajax.request({  
                     url:"/slider/deleteActivityPlatForm",  
                     params:{id:ids},  
                     method:'post',  
                     success:function(o){   
    ...
    //添加服务	      
		var addActivityEntrance = function(activity_id){  
			var columns = [ {header:'序号',xtype: 'rownumberer',width:50},
			                ...
			                {header:'平台描述',dataIndex:'platform',sortable:true,fixed:false}
		...
		var storeCatalogService = Ext.create("Ext.data.Store", {
			...
			proxy : {
				type : 'ajax',
				url : '/slider/getActivityPlatForm',
				reader : {
					type : 'json',
					totalProperty : 'total',
					root : 'data',
            ...
            buttons : [{  
                       ...
                       handler : function() {
                         ...
                         {  
                      	 ...
                      	 Ext.Ajax.request({  
                      		 url :'/slider/addActivityPlatForm',  
                      		 params:{activity_id:activity_id,platform_id:ids},  
                               method:'post',  
                               success:function(fp, o){  
                                   ...
                                   return ;  
                            		   ...
                            		   Ext.example.msg("提示","请不要重复添加平台！"); 
                            		   issuewindow.close();
                            	   }
                               },  
                               failure:function(form,action){  
                            	   Ext.example.msg("提示","请不要添加重复平台！"); 
                               }  
                           }); 
                      	 }   
            } ,{
