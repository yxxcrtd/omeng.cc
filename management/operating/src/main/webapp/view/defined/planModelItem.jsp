...
Ext.onReady(function() {
    ...
    var store = Ext.create("Ext.data.Store",{
        ...
        proxy:{  
            type:'ajax',  
            url:'/defined/getPlanModelItemList',  
            reader:{  
                type:'json',  
                totalProperty:'total',  
                root:'data',  
  ...
  //点击下一页时传递搜索框值到后台  
	...
	items:[
	    	   ...
	    	   <cms:havePerm url='/defined/addPlanModelItem'>
		       ...
		       <cms:havePerm url='/defined/deletePlanModelItem'>
	           { xtype: 'button', id:'del', text: '删除',iconCls:'NewDelete',
			       ...
			       <cms:havePerm url='/defined/editPlanModelItem'>
      ...
      },
      {
        	...
        	dock:'top',
        	displayInfo: true,
        	items:[{ xtype: 'textfield',id:'model_id',name: 'model_id',fieldLabel: '字段ID',labelAlign:'left',value:'${model_id}',labelWidth:60,hidden:true},'-',
        	       { xtype: 'textfield',id:'item_name',name: 'item_name',fieldLabel: '枚举值',labelAlign:'left',labelWidth:60},'-',
         	      
        	       <cms:havePerm url='/defined/getPlanModelItemList'>
  ...
  //加载数据  
    ...
    {  
         ...
         Ext.Msg.confirm("提示信息","请确定要执行删除操作吗?",function (btn){  
             ...
             {  
                 Ext.Ajax.request({  
                     url:"/defined/deletePlanModelItem",  
                     params:{id:ids},  
                     method:'post',  
                     success:function(o){  
