...
<style>
			...
			.boxPannel li.li0{background:url(http://pmg.oomeng.cn/manager/image/huiyuanshuliang.png) no-repeat 43px center #f9ae53;}
			.boxPannel li.li1{background:url(http://pmg.oomeng.cn/manager/image/fuwushangshuliang.png) no-repeat 43px center #1bb672;}
			.boxPannel li.li2{background:url(http://pmg.oomeng.cn/manager/image/dailishangshuliang.png) no-repeat 43px center #79ccec;}
			.boxPannel li.li3{background:url(http://pmg.oomeng.cn/manager/image/dingdanshuliang.png) no-repeat 43px center #788af0;}
			.boxPannel li.li4{background:url(http://pmg.oomeng.cn/manager/image/shengdaishuliang.png) no-repeat 43px center #fe7352;}
			.boxPannel li.li5{background:url(http://pmg.oomeng.cn/manager/image/shidaishuliang.png) no-repeat 43px center #e872af;}
			.boxPannel li.li6{background:url(http://pmg.oomeng.cn/manager/image/xiangmudaishuliang.png) no-repeat 43px center #a6ce6b;}
</style>
	</head>
	<body>
		<div class="boxPannel">
