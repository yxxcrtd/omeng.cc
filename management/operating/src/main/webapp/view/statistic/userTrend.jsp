...
Ext.onReady(function() {
	             	 ...
	             	 smooth: true,
	             		tips : {
	             			...
	             			renderer : function(storeItem, item) {
	             				...
	             				this.setTitle(dd + '<br />注册量:' + storeItem.get('data'));
	             			}
	             		}
	             	}]
	});
            ...
            items:[{  
                   items:[ {xtype : 'datefield',id: 'startTime',
                	       ...
                	       {xtype : 'datefield',id: 'endTime',
                    	       ...
                    	       format : 'Y-m-d',labelAlign:'left',labelWidth:75},'-',
                    	       <cms:havePerm url='/statistic/exportUserTrendExcel'>
	...
	function exportAll() {
		   var startTime=Ext.getCmp('startTime').getValue();
		   var endTime=Ext.getCmp('endTime').getValue();
           window.location.href = '/statistic/exportUserTrendExcel?dimension='+dimension+'&startTime='+startTime+'&endTime='+endTime;	
	};
