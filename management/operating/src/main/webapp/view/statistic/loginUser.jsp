...
//列表详情
    ...
    var columns = [
                   ...
                   {header:'用户数量',itemId: 'terminalNum',align:'center',dataIndex:'terminalNum',sortable:true,fixed:false,width : 400},
                   {header:'省份',itemId: 'province',align:'center',dataIndex:'province',sortable:true,fixed:false,hidden:true,width : 500},
                   {header:'城市',itemId: 'city',align:'center',dataIndex:'city',sortable:true,fixed:false,hidden:true,width : 500}
                   ];
    ...
    var store = Ext.create("Ext.data.Store",{
        ...
        proxy:{  
            type:'ajax',  
            url:'/statistic/getLoginUserList',  
            reader:{  
                type:'json',  
                totalProperty:'total',  
                root:'data',  
    ...
    store.on('beforeload', function (store, options) {    
		...
		var new_params = { dimension:dimension,province:province,city:city,start_time:start_time,off_time:off_time};    
    ...
    var grid = Ext.create("Ext.grid.Panel",{
        ...
        dockedItems: [{
        	...
        	displayInfo: true,
        	items:['-',
        	       <cms:havePerm url='/statistic/exportLoginUserListExcel'>
   ...
   
      {
        	...
        	dock:'top',
        	displayInfo: true,
        	items:[{xtype : 'combobox',id : 'provinceFilter',name : 'province',fieldLabel : '省份',valueField : 'id',displayField : 'area',width : 250,
						store : provinceStore,
        	...
        	items:[
				   ...
				   <cms:havePerm url='/statistic/getLoginUserList'>
        	       { xtype: 'button', id:'select',text: '查询',iconCls:'Select',width : 100,listeners: {
    	    		   click:function(){		  
    	    				...
    	    				var off_time=Ext.getCmp('off_time').getValue();
    	    				store.currentPage = 1;
     	    			    store.load({params:{start:0,page:1,limit:20,dimension:dimension,province:province,city:city,start_time:start_time,off_time:off_time}}); 
    	    		   }
    	    		   }}
				   </cms:havePerm>
				   ]
 ...
 // 加载权限
  ...
  //导出
	function exportAll() {
		 ...
		 var start_time=Ext.getCmp('start_time').getValue();
		 var off_time=Ext.getCmp('off_time').getValue();
         window.location.href = '/statistic/exportLoginUserListExcel?dimension='+dimension+'&start_time='+start_time+'&off_time='+off_time
