...
Ext.onReady(function() {
	...
	var store = Ext.create("Ext.data.Store",{
        proxy:{  
            type:'ajax',  
            url:'/statistic/getUserOrderByTime',  
            reader:{  
                type:'json',  
                root:'data',  
                idProperty:'ext'  
	             	 ...
	             	 smooth: true,
	             		tips : {
	             			...
	             			renderer : function(storeItem, item) {
	             				...
	             				this.setTitle(dd + '<br />订单量:' + storeItem.get('data'));
	             			}
	             		}
	             	}]
	});
	    ...
	    tbar : [{  
            ...
            items:[{  
        	       ...
        	       {xtype : 'datefield',id: 'endTime',
            	       ...
            	       format : 'Y-m-d',labelAlign:'left',labelWidth:75},'-',
            	       <cms:havePerm url='/statistic/exportOrderTrendExcel'>
	...
	function exportAll() {
		   var startTime=Ext.getCmp('startTime').getValue();
		   var endTime=Ext.getCmp('endTime').getValue();
           window.location.href = '/statistic/exportOrderTrendExcel?dimension='+dimension+'&startTime='+startTime+'&endTime='+endTime;	
	};
