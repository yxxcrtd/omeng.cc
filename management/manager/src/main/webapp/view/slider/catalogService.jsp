...
Ext.onReady(function() {
  ...
  //点击下一页时传递搜索框值到后台  
	...
	displayInfo: true,
	items:[
	    	   <cms:havePerm url='/slider/addCatalogService'>
		       ...
		       <cms:havePerm url='/slider/deleteCatalogService'>
		       ...
		       <cms:havePerm url='/slider/auditCatalogService'>
      ...
      },
      {
        	...
        	items:[{xtype : 'combobox',id : 'status',name : 'status',fieldLabel : '发布状态',value:'',valueField : 'statusType',editable:false,displayField : 'statusName',
        	       ...
        	       <cms:havePerm url='/slider/getCatalog'>
  ...
  //加载数据  
    ...
    {  
         ...
         Ext.Msg.confirm("提示信息","请确定要执行删除操作吗?",function (btn){  
             ...
             {  
                 Ext.Ajax.request({  
                     url:"/slider/deleteCatalogService",  
                     params:{id:ids},  
                     method:'post',  
                     success:function(o){   
  ...
  //审核服务项目
    ...
    {  
         ...
         Ext.Msg.confirm("提示信息","请确定要执行发布操作吗?",function (btn){  
             if(btn == 'yes')  
             {  
                 Ext.Ajax.request({  
                     url:"/slider/auditCatalogService",  
                     params:{id:ids},  
                     method:'post',  
                     success:function(o){   
