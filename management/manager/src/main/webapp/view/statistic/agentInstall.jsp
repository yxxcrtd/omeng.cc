...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'加入时间',dataIndex: 'join_time',width:50,align:'center'},
 ...
 // 省信息
  ...
  //点击下一页时传递搜索框值到后台  
    store.on('beforeload', function (store, options) {    
		 ...
		 var e_start_time=Ext.getCmp('e_start_time').getValue();
		 var e_off_time=Ext.getCmp('e_off_time').getValue();
         var new_params = {invite_code:invite_code,province:province,city:city,start_time : start_time,off_time : off_time,e_start_time : e_start_time,e_off_time : e_off_time};    
    ...
    var grid = Ext.create("Ext.grid.Panel",{
        ...
        dockedItems: [{
        	...
        	dock:'top',
        	displayInfo: true,
        	items:[{ xtype: 'textfield',id: 'invite_code',name: 'invite_code',fieldLabel: '邀请码',labelWidth:55},'-',
			...
			displayInfo : true,
			items : [
{ xtype: 'datetimefield',id: 'e_start_time',name: 'e_start_time',format : 'Y-m-d',fieldLabel: '加入时间',labelAlign:'left',labelWidth:60},'~',
{ xtype: 'datetimefield',id: 'e_off_time',name: 'e_off_time',format : 'Y-m-d',labelAlign:'left',labelWidth:60},'-',
        	    ...
        	    { xtype: 'datetimefield',id: 'off_time',name: 'off_time',format : 'Y-m-d',labelAlign:'left',labelWidth:60},'-',
        	       ...
        	       { xtype: 'button',id:'select', text: '查询',iconCls:'Select',listeners: {
    	    		   click:function(){
    	    			   ...
    	    			   var e_off_time=Ext.getCmp('e_off_time').getValue();
    	    			   store.currentPage = 1;
    	    			   store.load({params:{start:0,page:1,limit:20,start:0,invite_code:invite_code,province:province,city:city,start_time : start_time,off_time : off_time,e_start_time : e_start_time,e_off_time : e_off_time}}); 
    	    		   }
    	    		   }}</cms:havePerm>
                   ]
        }],
  ...
  //导出所有订单
	function exportAll() {
		...
		var e_start_time=Ext.getCmp('e_start_time').getValue();
		var e_off_time=Ext.getCmp('e_off_time').getValue();
		window.location.href = '/analysis/exportAgentInstallExcel?province='+province+'&city='+city+'&invite_code='+invite_code
		         +'&start_time='+start_time+'&off_time='+off_time+'&e_start_time='+e_start_time+'&e_off_time='+e_off_time;
