...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'排名',dataIndex:'top',align:'center'},
                   ...
                   {header:'总粉丝',dataIndex:'total_fans_num',align:'center'},
                   {header:'昨日新增粉丝',dataIndex:'yesterday_increase_fans_num',align:'center'},
                   {header:'前日新增粉丝',dataIndex:'day_before_increase_fans_num',align:'center'},
                   {header:'增长比例',dataIndex:'increase_rate',align:'center'}
                   ];
	//创建store数据源
    ...
    var store = Ext.create("Ext.data.Store",{
        ...
        proxy:{  
            type:'ajax',  
            url:'/activity/getDayFensiRanking',  
            reader:{  
                type:'json',  
                totalProperty:'total',  
                root:'data',  
        ...
        fields:[  
           ...
           {name:'app_name'},
           {name:'total_fans_num'},
           {name:'yesterday_increase_fans_num'},
           {name:'day_before_increase_fans_num'},
           {name:'increase_rate'}
        ]  
    });
  ...
  //点击下一页时传递搜索框值到后台  
    ...
    var grid = Ext.create("Ext.grid.Panel",{
        ...
        dockedItems: [{
        	...
        	items:[
                  '-',
                <cms:havePerm url='/activity/exportExcelFensiAddRanking'>
  ...
  //导出所有粉丝
	function exportAll() {
		 ...
		 var city=Ext.getCmp('city').getRawValue();
		 var head_date=Ext.getCmp('head_date').getValue();
		window.location.href = '/activity/exportExcelFensiAddRanking?province='+province+'&city='+city+'&head_date='+head_date;
	};
	// 整体架构容器
