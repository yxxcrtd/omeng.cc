...
Ext.onReady(function() {
    var columns = [
                   ...
                   {header:'行业类型',dataIndex:'appName',width:50,align:'center'},
  ...
  //加载数据  
   ...
   // cityStore.load();
	...
	function exportAll() {
         ...
         window.location.href = '/valueAdded/exportVipMemberExcel?merchantName='+merchantName+'&telephone='+telephone+'&province='+province+'&clientType='+clientType
