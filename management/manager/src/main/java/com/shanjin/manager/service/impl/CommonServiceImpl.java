...
//	}
	...
	@Override
	public List<Record> getMqSendFailureList(Map<String, String[]> param) {
		return	commonDao.getMqSendFailureList(param);
	}
	@Override
	public boolean delOrderUserReAccount(Map<String, String[]> param, String operUserName) {
		return	commonDao.delOrderUserReAccount(param,operUserName);
	}
	@Override
	public boolean editMqSendFailureList(Map<String, String[]> param) {
		return	commonDao.editMqSendFailureList(param);
	}
