...
public class ActivityServiceImpl implements IActivityService {
	...
	@Override
	public List<Record> getOrderUserRewardAccountList(Map<String, String[]> filterParam) {
		return activityDao.getOrderUserRewardAccountList(filterParam);
	}

	@Override
	public List<OrderUserRewardAccount> exportOrderUserRewardAccountExcel(Map<String, String[]> filterParam) {
		return activityDao.exportOrderUserRewardAccountExcel(filterParam);
	}

	@Override
	public List<Pair> getExportOrderUserRewardAccountTitles() {
		List<Pair> titles = new ArrayList<Pair>();
		titles.add(new Pair("id", "id"));
		titles.add(new Pair("order_no", "订单号"));
		titles.add(new Pair("activity_name", "活动名称"));
	...
	public boolean delOrderUserReAccount(Map<String, String[]> param, String operUserName) {
		return activityDao.delOrderUserReAccount(param,operUserName);
	}

	@Override
	public boolean editOrderUserRewardAccount(Map<String, String[]> param, String operUserName) {
		return activityDao.editOrderUserRewardAccount(param,operUserName);
	}
