...
public interface IActivityService {
	...
	List<Record> getOrderUserRewardAccountList(Map<String, String[]> filterParam);

	List<OrderUserRewardAccount> exportOrderUserRewardAccountExcel(Map<String, String[]> filterParam);

	List<Pair> getExportOrderUserRewardAccountTitles();

	boolean delOrderUserReAccount(Map<String, String[]> param, String operUserName);

	boolean editOrderUserRewardAccount(Map<String, String[]> param, String operUserName);
