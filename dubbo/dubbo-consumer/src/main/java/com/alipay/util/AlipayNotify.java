...
public class AlipayNotify {
	...
	public static boolean verify(Map<String, String> params) {
		...
		BusinessUtil.writeLog("pay","进入支付宝的验证-"+params);
		...
		if (isSign && responseTxt.equals("true")) {
			System.out.println("====进入支付宝的验证成功====");
			BusinessUtil.writeLog("pay","进入支付宝的验证成功-"+params);
			return true;
		} else {
			System.out.println("====进入支付宝的验证失败====");
			BusinessUtil.writeLog("pay","进入支付宝的验证失败-"+params);
			return false;
		}
	}
