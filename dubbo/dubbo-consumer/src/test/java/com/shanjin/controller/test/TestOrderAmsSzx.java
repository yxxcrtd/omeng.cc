...
public class TestOrderAmsSzx {
    ...
    private String appType = "ams_szx";
    private String phone="13865954757";
    private String host =Constant.HOST;
	private CloseableHttpClient httpClient;
    private String merchantId="144358281935360079";
    private String clientId="11DC29EA10FAD898F93015507D80BD2E";
    private String employee_key="71F102CED5EB5EA7F03C9DE45516CBD0";
	...
	public void getServiceList() throws Exception{
			httpPost = new HttpPost(host+"/common/amsServiceTypeName");
			List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
	        parameters.add(new BasicNameValuePair("appType", appType));
	        parameters.add(new BasicNameValuePair("loadDict", "true"));
	 ...
	 */
	@Test
	public void getAgentItemList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", appType+"_1")); 
        ...
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", appType+"_2")); 
		...
		parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", appType+"_3")); 
	...
	public void orderBusiness() throws Exception {
		String orderId="";	
		String planId="";
		String userId="144145477796633312";
	    ...
	    Thread.sleep(1000); 
        this.detailOrderInfo(orderId, "1");
	    ...
	    Thread.sleep(1000); 
        this.detailOrderInfo(orderId, "3");
	...
	public String  saveOrder(String userId,String serviceType) throws Exception{
        ...
        if (serviceType.equals("1")) {
        	//租赁
        	entity.addPart("catalog", new StringBody("11", Charset.forName("UTF-8")));
        	entity.addPart("class", new StringBody("111", Charset.forName("UTF-8")));
        }else if (serviceType.equals("2")) {
        	//维修
        	entity.addPart("catalog", new StringBody("22", Charset.forName("UTF-8"))); 
        	entity.addPart("class", new StringBody("123", Charset.forName("UTF-8")));
        }else if (serviceType.equals("3")){
        	//服装定制
        	entity.addPart("quality", new StringBody("12", Charset.forName("UTF-8"))); 
        }
                
        entity.addPart("demand", new StringBody("距离不要太远", Charset.forName("UTF-8")));
        entity.addPart("agentTime", new StringBody("2015-09-28 18:22:10", Charset.forName("UTF-8")));
	...
	@Test
	public void merchantOrderList() throws Exception {
		init();
        ...
        entity.addPart("serviceType", new StringBody("1", Charset.forName("UTF-8")));
        entity.addPart("pageNo", new StringBody("0", Charset.forName("UTF-8")));
