...
public class TestOrderYdh{
    ...
    private String appType = "ydh";
    private String phone="14600000000";
    private String host =Constant.HOST;
	private CloseableHttpClient httpClient;
    private String merchantId="144005101104660652";
    private String clientId="00DC29EA10FAD898F93015507D80BD1D";
    private String employee_key="D3E15469ADAEBEB0388EBE323FDB1C69";
	 ...
	 */
	@Test
	public void getNatatoriaTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "ydhNatatoriaType")); 
	 ...
	 */
	@Test
	public void getBallTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "ydhBallType")); 
	...
	public String  saveOrder(String userId,String serviceType) throws Exception{
        ...
        if(serviceType.equals("1")){
            entity.addPart("ballType", new StringBody("1", Charset.forName("UTF-8")));        	
        }
        if(serviceType.equals("2")){
        	entity.addPart("gymType", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("gymWay", new StringBody("1", Charset.forName("UTF-8")));
        }
        if(serviceType.equals("3")){
            entity.addPart("skatingSiteType", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("reservationNumber", new StringBody("4", Charset.forName("UTF-8")));        	
        }
        if(serviceType.equals("4")){
            entity.addPart("natatoriaType", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("reservationNumber", new StringBody("4", Charset.forName("UTF-8")));        	
        }    
        entity.addPart("consumptionTimePeriod", new StringBody("1h-2h", Charset.forName("UTF-8")));    
