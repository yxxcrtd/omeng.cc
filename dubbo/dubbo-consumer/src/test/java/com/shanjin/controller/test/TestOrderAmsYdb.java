...
public class TestOrderAmsYdb {
    ...
    private String appType = "ams_ydb";
    private String phone="13865954757";
    private String host =Constant.HOST;
	private CloseableHttpClient httpClient;
    private String merchantId="144343111704405177";
    private String clientId="11DC29EA10FAD898F93015507D80BD2E";
    private String employee_key="9DE223608FCD227E06939C2C7D0B98FD";
	...
	public String  saveOrder(String userId,String serviceType) throws Exception{
        ...
        if (serviceType.equals("1")) {
        	//工商代办
        	entity.addPart("serviceItem", new StringBody("11", Charset.forName("UTF-8")));
        }else if (serviceType.equals("2")) {
        	//财务代办
        	entity.addPart("serviceItem", new StringBody("21", Charset.forName("UTF-8")));    
        }else if (serviceType.equals("3")){
        	//签证服务
        	entity.addPart("signCountry", new StringBody("31", Charset.forName("UTF-8"))); 
        }else if (serviceType.equals("6")){
        	//商标名称
        	entity.addPart("brandName", new StringBody("测试而已", Charset.forName("UTF-8"))); 
        }
