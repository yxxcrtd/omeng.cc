...
public class TestUserSxdOrderController {

	private CloseableHttpClient httpClient;
	private HttpPost httpPost;
	private String appType = "sxd";
	...
	public void testGetBasicOrder() throws Exception {
		...
		List<NameValuePair> parameters = new ArrayList<NameValuePair>();
		parameters.add(new BasicNameValuePair("appType", appType));
		parameters.add(new BasicNameValuePair("orderId", "1058"));
	...
	public void testGetDetialOrderInfo() throws Exception {
		...
		List<NameValuePair> parameters = new ArrayList<NameValuePair>();
		parameters.add(new BasicNameValuePair("appType", appType));
		parameters.add(new BasicNameValuePair("orderId", "1439"));
	...
	public void testSaveOrder() throws Exception {
		String orderId = "";
		String merchantId = "143861142426862966";
		String serviceType = "1";
		String planId = "";
		{
			// Step1: 保存订单
			orderId = this.saveSxdOrder(serviceType);
			// Step1.5: 商户抢单
	...
	private String saveSxdOrder(String serviceType) throws Exception {
		String orderId = "";
		// Step1: 保存订单
		...
		parameters.add(new BasicNameValuePair("identity", "2"));
		parameters.add(new BasicNameValuePair("monthlyIncome", "300"));
		parameters.add(new BasicNameValuePair("applyLoanCity", "合肥"));
		parameters.add(new BasicNameValuePair("traffic", "1"));
		parameters.add(new BasicNameValuePair("house", "1"));
		parameters.add(new BasicNameValuePair("hopeLoanAmount", "100"));
		parameters.add(new BasicNameValuePair("hopeLoanDeadline", "3"));
		parameters.add(new BasicNameValuePair("haveGuarantee", "2"));
		parameters.add(new BasicNameValuePair("loanPurpose", "1"));
