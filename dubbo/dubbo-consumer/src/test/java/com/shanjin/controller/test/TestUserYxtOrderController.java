...
public class TestUserYxtOrderController {

	private CloseableHttpClient httpClient;
	private HttpPost httpPost;
	private String appType = "yxt_yxt";
	...
	public void testSaveOrder() throws Exception {
		String orderId = "";
		String merchantId = "143882721628445734";
		String serviceType = "73";
		String planId = "";
		{
			// Step1: 保存订单
			orderId = this.saveYxtOrder(serviceType);
			// Step1.5: 商户抢单
	...
	private String saveYxtOrder(String serviceType) throws Exception {
		String orderId = "";
		// Step1: 保存订单
		...
		parameters.add(new BasicNameValuePair("serviceItem", "艺术 体育"));
		parameters.add(new BasicNameValuePair("serviceClass", "器乐1"));
