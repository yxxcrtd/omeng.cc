...
public class TestOrderSwg {
    ...
    private String appType = "swg";
    private String phone="14600000000";
    private String host = Constant.HOST;
	private CloseableHttpClient httpClient;
    private String merchantId="144005095916317762";
    private String clientId="00DC29EA10FAD898F93015507D80BD1EEE";
    private String employee_key="376A8633BE99CC0EE6C164639963CE2D";
	...
	public String  saveOrder(String userId,String serviceType) throws Exception{
        ...
        if(serviceType.equals("1")){
            entity.addPart("mahJong", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("poker", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("chess", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("appendService", new StringBody("1,2,3", Charset.forName("UTF-8")));
        }
        if(serviceType.equals("2")){
        	entity.addPart("seatingArea", new StringBody("1", Charset.forName("UTF-8")));
        }
        if(serviceType.equals("3")){
        	entity.addPart("seatingArea", new StringBody("1", Charset.forName("UTF-8")));
        }
        entity.addPart("reservationPeopleCount", new StringBody("5", Charset.forName("UTF-8")));
