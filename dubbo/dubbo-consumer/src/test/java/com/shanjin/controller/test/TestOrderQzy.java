...
public class TestOrderQzy {
    ...
    private String appType = "qzy";
    private String phone="14600000000";
    private String host =Constant.HOST;
	private CloseableHttpClient httpClient;
    private String merchantId="144005099210135764";
    private String clientId="00DC29EA10FAD898F93015507D80BD1B";
    private String employee_key="EF0C4D3440E9FED231D9290ADBB7A908";
	 ...
	 */
	@Test
	public void getPhotographTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "qzyPhotographType")); 
	 ...
	 */
	@Test
	public void getClassTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "qzyClassType")); 
	...
	public void getServiceTypeList()throws Exception{
		...
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "qzyServiceType")); 
	...
	public String  saveOrder(String userId,String serviceType) throws Exception{
        ...
        if(serviceType.equals("2")){//儿童摄影
            entity.addPart("photographType", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("shootingAddress", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("expectedConsumption", new StringBody("1", Charset.forName("UTF-8")));
        	
        }
        if(serviceType.equals("4")){// 早期教育
        	entity.addPart("babySex", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("babyAge", new StringBody("2-3", Charset.forName("UTF-8")));
            entity.addPart("classTime", new StringBody("周一，周二，周三", Charset.forName("UTF-8")));
            entity.addPart("teacherSex", new StringBody("1", Charset.forName("UTF-8")));
        }
        if(serviceType.equals("1")){// 亲子游乐
            entity.addPart("amusementType", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("expectedConsumption", new StringBody("1", Charset.forName("UTF-8")));        	
        }
        if(serviceType.equals("3")){//母音护理
            entity.addPart("nurseServiceType", new StringBody("1", Charset.forName("UTF-8")));        	
        }      
