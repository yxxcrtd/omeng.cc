...
public class TestUserXqbOrderController {

	
	    private String APP_TYPE="yxt_xqb";
		...
		public void testSaveOrder() throws Exception {
			...
			{
				// Step1: 保存订单
				orderId = this.saveXqbOrder(serviceType);
				// Step1.5: 商户抢单
		...
		private String saveXqbOrder(String serviceType) throws Exception {
			String orderId = "";
			// Step1: 保存订单
			...
			parameters.add(new BasicNameValuePair("serviceClass", "双节棍"));
