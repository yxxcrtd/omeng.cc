...
public class TestUserJzxOrderController {

	private CloseableHttpClient httpClient;
	private HttpPost httpPost;
	private String appType = "jzx";
	...
	public void testSaveOrder() throws Exception {
		String orderId = "";
		String merchantId = "83";
		String serviceType = "1";
		String planId = "";
		{
			// Step1: 保存订单
			orderId = this.saveOrder(serviceType);
			// Step1.5: 商户抢单
	...
	private String saveOrder(String serviceType) throws Exception {
		String orderId = "";
		// Step1: 保存订单
		...
		parameters.add(new BasicNameValuePair("decorationStyle", "1"));
		parameters.add(new BasicNameValuePair("decorationArea", "120"));
		parameters.add(new BasicNameValuePair("decorationRange", "1,2"));
		parameters.add(new BasicNameValuePair("houseModel", "1"));
		parameters.add(new BasicNameValuePair("decorationWay", "1"));
		parameters.add(new BasicNameValuePair("decorationLevel", "1"));
		parameters.add(new BasicNameValuePair("decorationBudgetMoney", "100000"));
