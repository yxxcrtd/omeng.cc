...
public class TestUserCgtOrderController {

	
	    private String APP_TYPE="yxt_cgt";
		...
		public void testSaveOrder() throws Exception {
			String orderId = "";
			String merchantId = "144012073328722251";
			String serviceType = "68";
			String planId = "";
			{
				// Step1: 保存订单
		...
		public void testUserEvaluation() throws Exception {
			...
			List<NameValuePair> parameters = new ArrayList<NameValuePair>();
			parameters.add(new BasicNameValuePair("appType", APP_TYPE));
			parameters.add(new BasicNameValuePair("merchantId", "144012073328722251"));
			parameters.add(new BasicNameValuePair("pageNo", "0"));
