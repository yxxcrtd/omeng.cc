...
public class TestOrderZyd {
	 ...
	 */
	@Test
	public void getMobileDevelopmentPlatformList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "zydMobileDevelopmentPlatform")); 
	 ...
	 */
	@Test
	public void getProductDirectionList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "zydProductDirection")); 
	 ...
	 */
	@Test
	public void getSoftTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "zydSoftType")); 
	 ...
	 */
	@Test
	public void getWebSiteTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "zydWebSiteType")); 
	 ...
	 */
	@Test
	public void getMakeTypeList()throws Exception{
        httpPost = new HttpPost(host+"/dictInfo/getDicts");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>(); 	
        parameters.add(new BasicNameValuePair("appType", appType));
        parameters.add(new BasicNameValuePair("dictType", "zydMakeType")); 
	...
	public String  saveOrder(String userId,String serviceType) throws Exception{
        ...
        if(serviceType.equals("1")){     
        	entity.addPart("makeType", new StringBody("1", Charset.forName("UTF-8"))); 	
        }
        if(serviceType.equals("2")){
            entity.addPart("webSiteDevelopmentPlatform", new StringBody("1", Charset.forName("UTF-8")));    
            entity.addPart("webSiteType", new StringBody("1", Charset.forName("UTF-8")));  
        }
        if(serviceType.equals("3")){
            entity.addPart("mobileDevelopmentPlatform", new StringBody("1", Charset.forName("UTF-8")));
            entity.addPart("productDirection", new StringBody("1", Charset.forName("UTF-8")));        	
        }
        if(serviceType.equals("4")){
            entity.addPart("softType", new StringBody("1", Charset.forName("UTF-8")));      	
        }   
   
        entity.addPart("developmentBudge", new StringBody("1w-2w", Charset.forName("UTF-8")));    
        entity.addPart("finishTime", new StringBody("1月-2月", Charset.forName("UTF-8")));       
