...
public class TestUserHzOrderController {

	private CloseableHttpClient httpClient;
	private HttpPost httpPost;
	private String APP_TYPE="hz_aml";
	@Before
	public void init() {
	...
	private String saveHzOrder(String serviceType) throws Exception {
		String orderId = "";
		// Step1: 保存订单
		httpPost = new HttpPost(Constant.HOST + "/userOrder/saveOrder");
		List<NameValuePair> parameters = new ArrayList<NameValuePair>();
		parameters.add(new BasicNameValuePair("appType", APP_TYPE));
        parameters.add(new BasicNameValuePair("userId", "119"));
        parameters.add(new BasicNameValuePair("serviceType", serviceType));
        parameters.add(new BasicNameValuePair("serviceItemIds", "2,12,24"));
        parameters.add(new BasicNameValuePair("serviceWay", "1"));
        parameters.add(new BasicNameValuePair("serviceTime", "2015-07-18 10:10:45"));
